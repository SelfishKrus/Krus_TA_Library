...
[CustomEditor(typeof(KrusGrassPainter))]    // which class the editor operates on 
public class KrusGrassPainterEditor : Editor
{
    KrusGrassPainter grassPainter;
    readonly string[] toolbarStrings = { "Add", "Remove", "Edit" };
    
    // access to modify KrusGrassPainter when activated
    private void OnEnable()
    {
        grassPainter = (KrusGrassPainter)target;
    }
